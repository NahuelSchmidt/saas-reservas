...
import { cancelEnrollmentAction, registerClassPaymentAction } from "./actions";
...
export function MySessionCard({ tenantSlug, session }: { tenantSlug: string; session: MySessionCardData }) {
                  ...
                  {e.paymentStatus === "PAID" ? (
                    ...
                    <Select onValueChange={(v) => registerPayment(e.id, v)} disabled={isPending}>
                      ...
                      <SelectContent>
                        ...
                        <SelectSeparator />
                        <SelectGroup>
                          <SelectLabel>Me pagó a mí</SelectLabel>
