...
import { updateClassTypeAction } from "./actions";
import {
  Select,
  SelectContent,
  SelectItem,
...
export function ClassTypeActiveToggle({
  tenantSlug,
  classTypeId,
  active,
}: {
  ...
  function handleChange(value: string | null) {
    ...
    startTransition(async () => {
      ...
      const result = await updateClassTypeAction(tenantSlug, classTypeId, formData);
